...
// class VoicebotAssistant extends StatefulWidget {
//   const VoicebotAssistant({Key? key}) : super(key: key);

//   @override
//   State<VoicebotAssistant> createState() => _VoicebotAssistantState();
// }

// class _VoicebotAssistantState extends State<VoicebotAssistant>
...
//               'parts': [
//                 {
//                   'text': 'Respond briefly and naturally in the same language as the query: $text'
//                 }
//               ]
//             }
//           ]
...
//       } else {
//         setState(() {
//           _response = 'Sorry, I couldn\'t process your request. Please try again.';
//         });
//       }
//     } catch (e) {
//       setState(() {
...
//                                     : const Color(0xFF533483).withOpacity(0.8),
//                                   _isListening 
...
//                     if (_response.isNotEmpty)
//                       ElevatedButton(
//                         onPressed: () => _speakResponse(_response),
//                         style: ElevatedButton.styleFrom(
